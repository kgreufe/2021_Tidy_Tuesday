...
georgia_pop %>% 
  ...
  theme(axis.ticks = element_blank(), 
        ...
        legend.background = element_rect(fill = "#e1cfb7"),
        legend.key = element_rect(fill = "#e1cfb7"), 
        legend.key.width = unit(2.5, "cm"),
        plot.background = element_rect(fill = "#e1cfb7", color = "#e1cfb7"), 
        panel.background = element_rect(fill = "#e1cfb7", color = "#e1cfb7"), 
